...
Rails.application.configure do
  ...
  # No host allowlist — this app is bound to a Tailscale tailnet by the
  # network_mode: host docker setup, and Tailscale ACL is the access boundary.
  # Without this, Rails would reject requests whose Host header is the NAS's
  # MagicDNS name (e.g. nas.<tailnet>.ts.net:3001).
  config.hosts.clear
end
